...
namespace RecipeManager.Data.Migrations
{
    ...
    [Migration("20220723182738_addRecipesToDbContext")]
    partial class addRecipesToDbContext
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RecipeManager.Data.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("RecipeManager.Data.ApplicationUser", null)
                        .WithMany()
